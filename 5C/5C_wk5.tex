...
|\vec{E}| = Q/(\epsilon_0 A)\,,
$
with $A$ being the area of each of the plates and $Q$ being the amount of positive charges stored at the top plate. There is an equal amount of negative charges $-Q$ stored at the bottom plate. The electric field and potential that we study in the week-4 worksheet problem 2 are in fact created by a capacitor. From there, you see that the top and bottom plates have different electric potential, that we call a potential difference $\Delta V$, between the two plates.\\


\noindent \textbf{Part (a)} For a parallel-plate capacitor separated by a distance $d$, show that \footnote{Hint: Review what we did in week-4 worksheet problem 2.}
