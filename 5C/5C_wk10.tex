...
\end{align*}
The superscript $*$ is a notation that indicates $^{214}_{83}\text{Bi}^*$ has its electrons in excited states, and the electrons "jump" to the ground state (with the corresponding atom denoted as ${}^{214}_{83}\text{Bi}$) by emitting a $\gamma$-ray. The wavelength of such $\gamma$-ray is measured to be $\lambda = 7.05\cdot 10^{-31}\,\text{m}$. Find the energy difference between the $^{214}_{83}\text{Bi}^*$ atom and the ${}^{214}_{83}\text{Bi}$ atom in this process. \\
...
\end{align*}
This is the energy difference between the $^{214}_{83}\text{Bi}^*$ atom and the $^{214}_{83}\text{Bi}$ atom in this process. Therefore,
\begin{align*}
...
1\,\text{g}$ of $^{238}_{92}\text{U}$. After one half-life, the amount remaining is $0.50\,\text{g}\,.$ After two half-lives, the amount remaining is $
0.25\,\text{g}\,.$
