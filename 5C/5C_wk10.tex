...
\begin{align*}
m_{p+n} &= 92m_p + 146m_n= 92(1.007276\,\text{u}) + 146(1.008665\,\text{u})= 239.934482\,\text{u} \approx 239.93\,\text{u}\,.
\end{align*}
...
\end{align*}
Therefore, the mass defect is \footnote{\underline{\textbf{Clarification}}: The formula that you have learned during lecture for mass defect (and also for binding energy) is for the nucleus only, that does not include the electrons. Here the given mass $m_{{}^{238}_{92}\text{U}} = 238.050788\,\text{u}$ includes the nucleus and the electrons in the atom, so I also added the mass of electrons in my calculation. Given the context of a problem, you might be asked to calculate the mass defect (or binding energy) of the nucleus itself, or the binding of the entire atom. The only difference in the two calculation is whether or not you need to take account for the individual masses of the electrons, such that the subtraction makes sense. If we were calculating the mass defect of the nucleus itself, we should compare the sum of the individual proton and neutron  masses with the Uranium-238 nucleus mass $m_{\text{nucleus}} = 238.000325$\,u. The nucleus mass is slightly less than the atom mass.}
\begin{align*}
\Delta m &= 239.984951\,\text{u} - 238.050788\,\text{u}= 1.934163\,\text{u}\approx 1.93\,\text{u}\,.
\end{align*}
Now we turn the mass defect into binding energy (of the atom) by Einstein's relation
\begin{align*}
E = (\Delta m)c^2\,.
\end{align*}
