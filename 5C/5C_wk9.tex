...
\lambda = \frac{h}{mv}\,.
\end{align*}
To find the momentum $mv$ of the electron, we use the non-relativistic kinetic energy formula
\begin{align*}
...
\text{KE} = 2.77\times 10^{-19}\,\text{J}\,.
\end{align*}
Therefore,
\begin{align*}
mv = 7.10\times 10^{-25}\,\text{kg}\cdot\text{m/s}\,.
\end{align*}
Now plug this into the de Broglie formula,
\begin{align*}
\lambda = \frac{6.63\times 10^{-34}}{7.10\times 10^{-25}}\,\text{m}
= 9.34\times 10^{-10}\,\text{m}\,.
\end{align*}
So the de Broglie wavelength is
\begin{align*}
\lambda \approx 9.3\times 10^{-10}\,\text{m} = 0.93\,\text{nm}\,.
\end{align*}
...
so
\begin{align*}
\lambda = \frac{1240\,\text{eV}\cdot\text{nm}}{0.88\,\text{eV}}
= 1.41\times 10^3\,\text{nm}\,.
\end{align*}
Therefore the required absorbed wavelength is
\begin{align*}
\lambda \approx 1410\,\text{nm} = 1.41\,\mu\text{m}\,.
\end{align*}
If you prefer SI units, this is $
\lambda \approx 1.41\times 10^{-6}\,\text{m}\,.$
\vfill

\begin{center}
\includegraphics[scale=0.135]{michgiganLake}\\
\hfill\break
Sunrise at Lake Michigan at Chicago, IL. Pictured in March 2026.\\
Sorry, I don't have any doodle cartoon on this worksheet to entertain you :(
\end{center}
