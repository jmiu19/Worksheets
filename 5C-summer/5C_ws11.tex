...
\newpage
\noindent \textbf{Problem 2}: Jinyan has been addicted to playing the game called Factorio with his friends, where they build automated factories. One late-game resource is Uranium: Uranium processing mostly produces the isotope $_{92}^{238}$U, which is essential in the production of nuclear fuel and “atomic bombs.” The $_{92}^{238}$U atom is unstable: It will undergo an atomic decay chain, releasing energy in this process (and this is why we say that $_{92}^{238}$U is radioactive), until it ends up at the stable isotope $^{206}_{82}$Pb. The decay chain is a combination of $\alpha$, $\beta$, and $\gamma$ decays. \\
...
\end{align*}
The superscript $*$ is a notation that indicates $^{214}_{83}\text{Bi}^*$ has its nucleus in an excited state, and the nucleus ``jumps" to the ground state (with the corresponding atom denoted as ${}^{214}_{83}\text{Bi}$) by emitting a $\gamma$-ray. The wavelength of such a $\gamma$-ray is measured to be $\lambda = 7.05\cdot 10^{-13}\,\text{m}$. Find the energy difference between the $^{214}_{83}\text{Bi}^*$ atom and the ${}^{214}_{83}\text{Bi}$ atom in this process. \\

\noindent\textbf{Part (b)} Do a quick Google search, and explain why the $\gamma$-ray released in part (a) is highly dangerous to humans. (Hint: What is the frequency of the emitted $\gamma$-ray?) Since the $\gamma$ decay process in part (a) is part of the decay chain of $^{238}_{92}$U, your answer is the main reason why the decay of radioactive substances like $^{238}_{92}$U can ``kill" people. \\

\noindent\textbf{Part (c)} The half-life of $^{238}_{92}$U is around $4.5\cdot 10^9$ years. We have $1$ gram of pure $^{238}_{92}$U. How long does it take for at least $0.75$ grams of it to decay into other substances? \footnote{The decay of a radioactive substance is a random process: A standard nuclear reactor uses $20$ tonnes of Uranium a year, which is on the scale of $10^{28}$ Uranium atoms. Therefore, even though the half-life of Uranium is very long, decay events are still highly likely to occur every second, given the large number of atoms in the reactor.}\\

\noindent\textbf{Part (d)} At the time computed in part (c), how does the activity of the Uranium sample compare with its initial activity when the sample contained one gram of $^{238}_{92}$U?

\vfill
\begin{center}
\includegraphics[scale=0.85]{elements.pdf}
\end{center}
...
\lambda = \frac{h}{mv}\,.
\end{align*}
To find the momentum $mv$ of the electron, we use the non-relativistic kinetic-energy formula for an electron with mass $m_e$, 
\begin{align*}
...
\end{align*}
The kinetic energy is the one we found in part (d) and the mass is the electron mass,
\begin{align*}
...
\end{align*}
Now plug this into the de Broglie formula to get the de Broglie wavelength of the electron,
\begin{align*}
...
So we calculate
\begin{align*}
E &= \frac{(6.63\times 10^{-34}\,\text{J}\cdot \text{s})(3.0\times 10^8\,\text{m/s})}{7.05\times 10^{-13}\,\text{m}}= 2.82\times 10^{-13}\,\text{J}\,.
\end{align*}
...
t=9.0\times 10^9\,\text{years}$ and $t_{1/2}=4.5\times 10^9\,\text{years}$. Plugging this result into the activity-decay formula, 
\begin{align*}
R=R_0\left(\frac{1}{2}\right)^{t/t_{1/2}}=R_0\left(\frac{1}{2}\right)^2=\frac{R_0}{4}\,.
\end{align*}
Thus, at the time computed in part (c), the activity of the Uranium sample is one-fourth of its initial activity. In other words, the activity has decreased by a factor of four. Just as expected, the amount of Uranium-238 decreases by a factor of 4, and the activity also decreases by a factor of 4. \\
\vfill 
