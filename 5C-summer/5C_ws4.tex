...
\begin{document}
\Large \noindent \textbf{Physics 5C Discussion (Worksheet 4)}\\
\normalsize
...
\begin{center}\includegraphics[scale=0.8]{trianglePotential}
\end{center}
...
\newpage
\noindent\textbf{Problem 2}: [The computation in this problem should be very very very very very easy.]\\
...
Now if I put another charge $q_3$ into this region, from worksheet 3, we know that $q_3$ will have electric potential energy 
\begin{align*}
...
\hfill\break
The photo of this week is the first metro line in Guangzhou, China.\ \ \ :D\\
I took this picture in December 2025. 
\end{center}
