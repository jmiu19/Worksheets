...
\begin{wrapfigure}[10]{r}{0.42\textwidth}
  ...
  \end{center}
\end{wrapfigure}
\Large \noindent \textbf{Physics 5A Discussion (Week 7)}\\
\normalsize
...
\noindent \textbf{Part 2}: At the bottom of the circular path, compute the tension force that the rope exerts on the pumpkin. (\textit{Hint: You can find the net force on the pumpkin using the centripetal motion formulas, and you can find the gravitational force in the usual way.)}
\hfill\break\hfill\break\hfill\break
\hfill\break\hfill\break\hfill\break
\hfill\break\hfill\break\hfill\break
...
\noindent\textbf{Part 7}: (DIFFICULT) Draw the free-body diagram of the pumpkin when it travels to the position as shown in the front-page figure. (\textit{Hint: Does the tension force by the rope point to the center of the circular path in this case?})
